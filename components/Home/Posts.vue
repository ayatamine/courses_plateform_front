  ...
  <section class="events-section">
    <div class="auto-container">
      ...
      <div class="row clearfix">
        ...
        <!-- Event Block Two -->
        <div class="event-block-two col-lg-6 col-md-12 col-sm-12" v-for="post in posts">
          <div class="inner-box">
            <div class="clearfix">
              <!-- Event Date -->
              ...
              <!-- Event List -->
              <ul class="event-list">
                <li v-for="tag in post.tags.slice(0,2)"><nuxt-link to="/" @click.prevent>{{($i18n.locale =='en' ) ? tag.title_en :  tag.title }} </nuxt-link></li>
              </ul>
            </div>
...
<style scoped>
.events-section{
  background-color: #f0f5fb;padding-top: 3rem;
}
